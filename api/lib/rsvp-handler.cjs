...
const { generateTicket } = require('./ticket-generator.cjs');
const { createRSVP, checkEventCapacity } = require('./google-sheets.cjs');
const { normalizeEventId } = require('./ticket-payload.cjs');
