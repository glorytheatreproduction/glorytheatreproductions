...
console.log('\nRequired for designed ticket PNGs (not QR-only):')
console.log('  HTML_RENDER_API_KEY=...  (Api2PDF — https://www.api2pdf.com/)')
console.log('  SITE_URL=https://glorytheatreproductions.vercel.app  (loads Gotham fonts in rendered tickets)')
console.log('\nOptional for email delivery:')
console.log('  SENDGRID_API_KEY=...  (recommended for glorytheatreproduction@gmail.com sender)')
